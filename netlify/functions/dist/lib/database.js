...
exports.db = exports.getDatabase = exports.Database = void 0;
...
class Database {
    ...
    async updateCategoryProductCount(categoryId, count) {
    ...
    async findCustomizations(where = {}) {
    ...
    async findCustomizationById(id) {
    ...
    async countCustomizations(where = {}) {
    ...
    // Order operations
    async findOrders(where = {}, skip = 0, take = 20) {
    ...
    // Review operations
    async findReviews(where = {}, skip = 0, take = 20) {
    ...
    async createReviewPhotos(photos) {
        const results = [];
    ...
    async findCustomerMeasurements(customerId) {
    ...
    async createCustomerMeasurements(data) {
        const id = generateId();
        const result = await this.query(`
    ...
    async updateCustomerMeasurements(customerId, data) {
        const fields = [];
        const values = [];
        let paramCount = 1;
        for (const [key, value] of Object.entries(data)) {
    ...
    async updateCustomizationPreferences(customerId, data) {
        const fields = [];
        const values = [];
        let paramCount = 1;
        for (const [key, value] of Object.entries(data)) {
     ...
     */
    async authenticateWithSupabase(token) {
        if (!this.supabase)
            return null;
        try {
...
exports.db = {
    async getInstance() {
        return await (0, exports.getDatabase)();
    }
};
